...
### Amazon Win Check — Email Scan

IMAP accounts are also used in **Win Check Email Scan** tasks. Orbit scans your inbox for Amazon invite emails (FR or JP) and extracts winning accounts automatically — no browser needed.
